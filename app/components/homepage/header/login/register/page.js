  ...
  return (
    <div className="bg-[#F2F4F7]">
      <div className=" max-w-[1390px] mx-auto px-5 pb-[100px] pt-[20px]">
        <h1 className=" text-[#101828] text-[32px] font-bold text-center mb-5">
          CREATE AN ACCOUNT
        </h1>
        ...
        >
          <Form className="max-w-[950px] mx-auto bg-white p-[50px] space-y-[35px]">
            <div className="space-y-[15px]">
              <h2 className=" text-[#1D2939] text-[24px] font-bold">
              ...
              <div className=" flex flex-col gap-1">
                <label className="text-sm" htmlFor="calender">
                  Date of Birth
                </label>
                <Field
                  type="date"
                  name="dateofbirth"
                  className="text-[#000]/40 pr-5 py-4 border outline-none indent-3 rounded-md focus:ring-1 focus:ring-[#6E0586] focus:ring-offset focus:shadow-md focus:shadow-[#6E0586]"
                />
              ...
              <div className="flex items-center space-x-2">
                ...
                >
                  Subscribe to Opaline Shop emails for exclusive offers, rewards
                  and more
                </label>
              </div>
            </div>
            ...
            <div className=" space-y-[15px]">
              ...
              <div className=" space-y-2">
                ...
                <div className="flex items-center space-x-2 pb-[15px]">
                  <Checkbox
                    className="p-0"
                    required
                    defaultChecked={false}
